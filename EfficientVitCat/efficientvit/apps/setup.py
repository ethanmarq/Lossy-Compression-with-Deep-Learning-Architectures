...
def setup_data_provider(
    ...
    # Read compress and error values from dp_config
    compress = dp_config.get('compress', 'sz3')
    error = dp_config.get('error', '1E-1')
    ...
    # Added Args
    #data_provider_kwargs['compress'] = compress
    #data_provider_kwargs['error'] = error
